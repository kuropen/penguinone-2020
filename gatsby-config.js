    ...
    'gatsby-plugin-postcss',
    {
      ...
      options: {
        ...
        pages: [ // (optional, builds pages dynamically)
          // { 
          //   type: 'social_policy',         // TypeName from prismic
          //   match: '/social',  // Pages will be generated under this pattern
          //   path: '/social',        // Placeholder page for unpublished documents
          //   component: require.resolve('./src/templates/social.js'),
          // }
        ],
      }
    },
